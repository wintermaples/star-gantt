...
[日本語版 README](https://github.com/wintermaples/star-gantt/blob/main/README.ja.md) (this English README is canonical)
...
The full specification lives in [`docs/specs/`](https://github.com/wintermaples/star-gantt/tree/main/docs/specs) — `architecture.md`, the
...
See [CONTRIBUTING.md](https://github.com/wintermaples/star-gantt/blob/main/CONTRIBUTING.md). Short version: this is a hobby project with no
support guarantee; the plugin architecture exists so you can build what you need without
waiting for a maintainer. Security reports: see [SECURITY.md](https://github.com/wintermaples/star-gantt/blob/main/SECURITY.md).
